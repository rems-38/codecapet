...
const nextPart = function(result) {
    ...
    // Si il n'y a pas de facture dans les mails fecth (null dans la conf) alors on fait rien de plus
    if(configData.lastFactureName != null) {
...
function dlPdf(){
    // Par "défaut" on set le nom à null si ya pas du tout de pdf ou si c'est pas une facture de Capet
    const configData = get_config();
